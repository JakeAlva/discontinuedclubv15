...
<body data-page="blog">
  ...
  <script src="assets/catalog.js?v=43"></script>
...
<head>
  ...
  <link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet"><link rel="stylesheet" href="assets/style.css?v=43"><script type="application/ld+json">${schema}</script>
</head>
...
</main><div id="site-footer"></div><script src="assets/catalog.js?v=43"></script><script src="assets/app.js?v=43"></script></body></html>
`;
}
